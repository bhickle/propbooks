  ...
  return (
    <div>
      ...
      <div style={card}>
        ...
        <p style={{ color: "#94a3b8", fontSize: 13, marginBottom: 16 }}>Sign out of your RealVault account on this device.</p>
...
const ONBOARDING_STEPS = [
  { id: "welcome",  title: "Welcome to RealVault 👋",       sub: "Let's get your portfolio set up in 2 minutes." },
