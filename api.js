...
export const FLIPS = [
  {
    ...
    rehabItems:[
      { category:"Kitchen",          budgeted:18000, spent:16200, status:"complete",    contractorIds:[]  },
      { category:"Bathrooms (2)",    budgeted:12000, spent:11500, status:"complete",    contractorIds:[1] },
      { category:"Flooring",         budgeted:8500,  spent:5200,  status:"in-progress", contractorIds:[]  },
      { category:"Roof",             budgeted:9500,  spent:5600,  status:"in-progress", contractorIds:[]  },
      { category:"Exterior / Paint", budgeted:6000,  spent:0,     status:"pending",     contractorIds:[]  },
      { category:"HVAC",             budgeted:5500,  spent:0,     status:"pending",     contractorIds:[]  },
      { category:"Landscaping",      budgeted:2500,  spent:0,     status:"pending",     contractorIds:[]  },
    ],
  },
  {
    ...
    rehabItems:[
      { category:"Kitchen",          budgeted:14000, spent:15200, status:"complete", contractorIds:[]    },
      { category:"Bathroom",         budgeted:7000,  spent:7400,  status:"complete", contractorIds:[]    },
      { category:"Flooring",         budgeted:6500,  spent:6800,  status:"complete", contractorIds:[4]   },
      { category:"Windows",          budgeted:5500,  spent:5400,  status:"complete", contractorIds:[5]   },
      { category:"Electrical",       budgeted:3000,  spent:3100,  status:"complete", contractorIds:[]    },
      { category:"Exterior / Paint", budgeted:2000,  spent:1300,  status:"complete", contractorIds:[]    },
    ],
  },
  {
    ...
    rehabItems:[
      { category:"Full Kitchen Remodel",   budgeted:28000, spent:0, status:"pending", contractorIds:[] },
      { category:"Master Bath",            budgeted:18000, spent:0, status:"pending", contractorIds:[] },
      { category:"Secondary Baths (2)",    budgeted:14000, spent:0, status:"pending", contractorIds:[] },
      { category:"Addition / Expansion",   budgeted:22000, spent:0, status:"pending", contractorIds:[] },
      { category:"Flooring",               budgeted:8000,  spent:0, status:"pending", contractorIds:[] },
      { category:"Roof & Gutters",         budgeted:5000,  spent:0, status:"pending", contractorIds:[] },
    ],
  },
  {
    ...
    rehabItems:[
      { category:"Kitchen",          budgeted:16000, spent:15600, status:"complete", contractorIds:[] },
      { category:"Bathrooms (2)",    budgeted:13000, spent:12400, status:"complete", contractorIds:[] },
      { category:"Basement Finish",  budgeted:12000, spent:11800, status:"complete", contractorIds:[] },
      { category:"HVAC",             budgeted:7500,  spent:7200,  status:"complete", contractorIds:[] },
      { category:"Flooring",         budgeted:4500,  spent:4300,  status:"complete", contractorIds:[] },
      { category:"Exterior",         budgeted:2000,  spent:1500,  status:"complete", contractorIds:[] },
    ],
  },
];
