  ...
  return (
    <div>
      ...
      <div style={sectionS}>
        ...
        {assigned.length === 0 ? (
          <div style={{ padding: 32, textAlign: "center", color: "var(--text-muted)", fontSize: 13, background: "var(--surface-alt)", borderRadius: 12 }}>
            {dealContractors.length === 0 ? "No contractors on this rehab yet. Add contractors from the rehab's Contractors tab." : "No contractors assigned to this scope yet."}
          </div>
        ) : (
      ...
      <div style={sectionS}>
        ...
        <p style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 20 }}>Rehab expenses tagged to this rehab scope or matching category</p>
